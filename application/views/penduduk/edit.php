                ...
                <div class="block">
                    ...
                    <form action="<?php echo site_url('Penduduk/edit_proses/' . $penduduk['nik']) ?>" method="post" class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="nohp" class="form-control" value="<?php echo $penduduk['nohp'] ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="jk" id="example-chosen" class="select-chosen" required>
                                    ...
                                    <option value="L" <?php if ($penduduk['jk'] == 'L') {
                                                            echo "selected";
                                                        } ?>>Laki-Laki</option>
                                    <option value="P" <?php if ($penduduk['jk'] == 'P') {
                                                            echo "selected";
                                                        } ?>>Perempuan</option>
                                </select>
                            ...
                            <div class="col-md-9">
                                <select name="id_agama" id="example-chosen" class="select-chosen" required>
                                    ...
                                    <?php foreach ($agama as $row) : ?>
                                        <option value="<?php echo $row->id_agama ?>" <?php if ($row->id_agama == $penduduk['id_agama']) {
                                                                                            echo "selected";
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="alamat" class="form-control" value="<?php echo $penduduk['alamat'] ?>">
