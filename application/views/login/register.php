...
<head>
    ...
    <title>Register Akun Warga</title>
...
<body>
    ...
    <div id="login-container">
        ...
        <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
            <strong> Yuk Buat Akun Baru !!!</strong>
        </h1>
        <!-- END Register Header -->
        ...
        <div class="block animation-fadeInQuickInv">
            ...
            if ($this->session->userdata('sukses_register') != "") {
                echo '<div class="alert alert-success" role="alert"><button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><strong>SUKSES REGISTER!</strong> Yuk Login !!!</div>';
            }
            ...
            <form id="form-validation" action="<?php echo site_url('Login/register_proses') ?>" method="post" class="form-horizontal">
                ...
                <div class="form-group form-actions">
                    ...
                    <div class="col-xs-6 text-right">
                        <button type="submit" class="btn btn-effect-ripple btn-success" name="daftar"><i class="fa fa-plus"></i> DAFTAR</button>
                    </div>
                </div>
            </form>
            <!-- END Register Form -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="text-center">
                        <button type="button" class="btn btn-effect-ripple btn-sm btn-primary" data-dismiss="modal">Setuju</button>
                    </div>
                </div>
            </div>
        </div>
