                ...
                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 150px;">Nama Penduduk</th>
                            <th class="text-center" style="width: 150px;">Keluhan</th>
                            <th class="text-center" style="width: 150px;">Tanggal</t>
